...
def test_github_template_fixture_exists():
    ...
    assert template_path.exists(), f"GitHub template fixture not found at {template_path}"

    # Verify essential files
    assert (template_path / "Info.plist").exists(), "Info.plist not found in fixture"
    assert (template_path / "Resources").exists(), "Resources directory not found in fixture"
    assert (template_path / "Resources" / "document.html").exists(), "document.html not found in fixture"
    assert (template_path / "Resources" / "github.css").exists(), "github.css not found in fixture"
...
def test_download_github_template_if_missing(tmp_path):
    ...
    assert template_path.exists(), "GitHub template not found in cloned repository"

    # Verify essential files
    assert (template_path / "Info.plist").exists(), "Info.plist not found"
    assert (template_path / "Resources").exists(), "Resources directory not found"
    assert (template_path / "Resources" / "document.html").exists(), "document.html not found"
    assert (template_path / "Resources" / "github.css").exists(), "github.css not found"
